...
- HTTP 통신에서, 어떤 자원에 대한 CRUD 요청을 Resource와 [Method](https://www.notion.so/ffc62d683bc9449ab27340c8764a6cfe?pvs=21)로 표현하여 특정한 형태로 전달하는 방식
  - Resource - 자원, URI
  - [Method - 요청 방식, GET, POST 등](https://www.notion.so/ffc62d683bc9449ab27340c8764a6cfe?pvs=21)
  - Representation of Resource ([자원의 형태, JSON, XML](https://www.notion.so/ffc62d683bc9449ab27340c8764a6cfe?pvs=21))
